...
ccflags-y += -DCONFIG_RTW_DISABLE_HW_PDN
endif

ifeq ($(CONFIG_RTW_IOT_CCK_PD_INIT), y)
ccflags-y += -DCONFIG_RTW_IOT_CCK_PD_INIT
endif
...
ifeq ($(CONFIG_ALIBABA_ZEROCONFIG), y)
ccflags-y += -DCONFIG_ALIBABA_ZEROCONFIG
ccflags-y += -DCONFIG_ALIBABA_ZEROCONFIG_DBG
ccflags-y += -DCONFIG_TDMADIG
endif
